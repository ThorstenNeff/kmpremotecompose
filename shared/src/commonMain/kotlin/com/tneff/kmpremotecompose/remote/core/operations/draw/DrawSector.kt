...
/**
 * `DRAW_SECTOR` (opcode [Operations.DRAW_SECTOR]) — draw a filled pie sector of an oval.
 *
 * Wire layout: opcode byte + six big-endian floats `left, top, right, bottom, startAngle, sweepAngle`
 * (degrees; mirrors upstream `DrawSector` / `DrawBase6`, positional v1..v6). Floats may carry NaN ids.
 */
class DrawSector(
    val left: Float,
    val top: Float,
    ...
    override fun dump(): String =
        "DRAW_SECTOR l=$left t=$top r=$right b=$bottom start=$startAngle sweep=$sweepAngle"
