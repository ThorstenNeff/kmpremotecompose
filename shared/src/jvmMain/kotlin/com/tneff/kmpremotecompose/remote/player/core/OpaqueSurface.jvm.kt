...
/**
 * REM-75 (Epic B Desktop): Compose-Desktop is Skiko like iOS → 1:1 the iOS impl (REM-56). Compose-Desktop's
 * live surface is alpha-backed, so a SRC_OUT/CLEAR with a transparent source punches a hole instead of
 * compositing to black. Render into an explicitly OPAQUE Skia raster surface (RGB_888X has no alpha channel
