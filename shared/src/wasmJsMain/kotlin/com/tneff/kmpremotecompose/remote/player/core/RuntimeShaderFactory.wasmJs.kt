...
/**
 * REM-77 (Epic D, DATA_SHADER): Web (wasmJs) is Skiko (CanvasKit) → 1:1 the iOS/Desktop actual. Translate
 * AGSL→SkSL ([AgslToSksl]), compile via [RuntimeEffect.makeForShader], bind uniforms through
 * [RuntimeShaderBuilder], and bridge the resulting `org.jetbrains.skia.Shader` to a Compose [Shader] via
 * [asComposeShader]. Fail-soft: any SkSL compile error / unbound uniform → null → plain fill.
 */
